    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float4 node_1672 = tex2Dlod(_MainTex,float4(TRANSFORM_TEX(node_8397, _MainTex),0.0,0));
                float3 node_4676 = node_1672.rgb; // Modify color here
                v.vertex.xyz = node_4676;
